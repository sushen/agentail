...
# message = "I am available now you guides can join now. https://meet.google.com/jsk-cnos-hht"

message = "How far you are in this project ? https://github.com/sushen/goethestudent "
...
work_sheet = Connection().connect_worksheet("fb_profile")
