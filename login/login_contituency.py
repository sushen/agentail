...
class Login:
    def login(self, driver):
        ...
        try:
            ...
            FACEBOOK_USERNAME = os.getenv("contituency_USERNAME", "")
            FACEBOOK_PASSWORD = os.getenv("contituency_PASSWORD", "")
            ...
            driver.find_element(By.NAME, "password").send_keys(FACEBOOK_PASSWORD)
            time.sleep(2)
